...
namespace Xamarin.ExposureNotifications
{
    public static partial class ExposureNotification
    {
        ...
        static TimeSpan bgRepeatInterval = TimeSpan.FromHours(0.3);//changed for debug (default 6)
    ...
    public class BackgroundFetchWorker : Worker
    {
        ...
        {
            var result = Result.InvokeSuccess();
            Preferences.Set("back_ground", true);
            Xamarin.Essentials.Preferences.Set("back_ground_counter",
                1 + Xamarin.Essentials.Preferences.Get("back_ground_counter", 0));
            try
            {
            ...
            {
                Preferences.Set("back_ground_ex", $"{ex}");
                System.Diagnostics.Debug.WriteLine(ex);
                result = Result.InvokeRetry();
            }
            Preferences.Set("back_ground", false);
            return result;
        }
